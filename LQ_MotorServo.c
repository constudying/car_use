...
sint16 r_Duty = 0;      // 电机驱动占空比数值
sint16 l_Duty = 0;      // 电机驱动占空比数值
sint32 NowTime = 0;
...
void ServoInit (void)
{
    ATOM_PWM_InitConfig(ATOMSERVO1, Servo_Center_Mid - 170, 100);  //舵机频率为100HZ，初始值为1.5ms中值
