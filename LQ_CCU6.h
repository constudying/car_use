...
extern volatile float servo_mid;
...
//extern volatile double right_cs;
//extern volatile double left_cs;

/***************以上PID参数部分，有待依据不同道路特征以细化**********************/
extern volatile float mot_kp;
extern volatile float mot_kd;
extern volatile float mot_ki;
extern volatile float dir_kp;
extern volatile float dir_kd;
extern volatile float dir_ki;
extern volatile float dir_errorlas;
extern volatile float dir_errorder;
/***************以上PID参数部分，有待依据不同道路特征以细化**********************/
